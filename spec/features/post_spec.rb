  ...
  before do
    ...
    describe 'index' do
      ...
      it 'has a scope so that only post creator can see their posts' do
        other_user = User.create(first_name: "Non", last_name: "Authorized", email: "nonauth@example.com", password: "asdfasdf", password_confirmation: "asdfasdf", phone: "1234561234")
    ...
    describe 'new' do
      it 'has a link from the homepage' do
        employee = Employee.create(first_name: "Employee", last_name: "Authorized", email: "employee@example.com", password: "asdfasdf", password_confirmation: "asdfasdf", phone: "1234561234")
